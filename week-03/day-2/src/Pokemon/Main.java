...
public class Main {
  public static void main(String[] args) {
    ...
    chooseOnePokemon(pokemonOfAsh, wildPokemon, choosedPokemon);
  }

  private static void chooseOnePokemon(List<Pokemon> pokemonOfAsh, Pokemon wildPokemon,
                                       Pokemon choosedPokemon) {
    for (Pokemon pokemon : pokemonOfAsh) {
      if (pokemon.isEffectiveAgainst(wildPokemon)) {
        choosedPokemon = pokemon;
      }
    }
    System.out.print("I choose you, " + choosedPokemon.name);
  }
